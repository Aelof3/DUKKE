    ...
    return (
        ...
        >
            <RigidBody type={"fixed"} colliders="cuboid">
                ...
                {/* walls */}
                <Block args={[0.1, 70, 20]} position={[19.4,35,0]} color={wallColor} />
                <Block args={[0.1, 70, 20]} position={[9.5,35,-10]} rotation={[0,Math.PI/2,0]} color={wallColor} />
