...
export default function CityLevel3(props) {
    ...
    return (
        ...
        >
            ...
            {/* row 1 */}
            <RigidBody ref={carRef0} name={"car_reset"} position={[8,2,24.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[12, 4, 5]} color={carColors[0]}/>
            </RigidBody>
            <RigidBody ref={carRef1} name={"car_reset"} position={[8,4,-0.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[12, 8, 5]} color={carColors[1]}/>
            </RigidBody>

            {/* row 2 */}
            <RigidBody ref={carRef2} name={"car_reset"} position={[22,2,14.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[6, 4, 5]} color={carColors[2]}/>
            </RigidBody>
            <RigidBody ref={carRef3} name={"car_reset"} position={[22,1.5,-24.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[4, 3, 5]} color={carColors[3]}/>
            </RigidBody>
            <RigidBody ref={carRef4} name={"car_reset"} position={[22,2,-0.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[8, 4, 5]} color={carColors[4]}/>
            </RigidBody>

            {/* row 3 */}
            <RigidBody ref={carRef5} name={"car_reset"} position={[36,2,-18.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[12, 4, 5]} color={carColors[5]}/>
            </RigidBody>
            <RigidBody ref={carRef6} name={"car_reset"} position={[36,4,-0.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[12, 8, 5]} color={carColors[6]}/>
            </RigidBody>
            <RigidBody ref={carRef7} name={"car_reset"} position={[36,2,18.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[12, 4, 5]} color={carColors[7]}/>
            </RigidBody>

            {/* row 4 */}
            <RigidBody ref={carRef8} name={"car_reset"} position={[50,2,-23.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[12, 4, 5]} color={carColors[8]}/>
            </RigidBody>
            <RigidBody ref={carRef9} name={"car_reset"} position={[50,6,-8]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[12, 12, 5]} color={carColors[9]}/>
            </RigidBody>
            <RigidBody ref={carRef10} name={"car_reset"} position={[50,3,8]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
                <Block args={[12, 6, 5]} color={carColors[10]}/>
            </RigidBody>
            <RigidBody ref={carRef11} name={"car_reset"} position={[50,5,23.5]} rotation={[0,Math.PI/2,0]} type={"fixed"} colliders="cuboid">
