            ...
            <div className="relative flex items-end">
                ...
                <ul className="absolute bottom-8 left-4 flex flex-col gap-14 z-10 items-start justify-end">
                    <li className="text-white">
                        <Link to="/levels" className="px-8 py-6 bg-[#480043] hover:bg-blue-700 rounded-xl shadow-2xl shadow-black text-3xl border-2 border-white">
                            PLAY GAME
                        </Link>
                    </li>
                    <li className="text-white">
                        <button onClick={handleReset} className={`p-4 ${resetButton} hover:bg-blue-700 shadow-2xl shadow-black border-2 border-white rounded-md text-xs`}>
